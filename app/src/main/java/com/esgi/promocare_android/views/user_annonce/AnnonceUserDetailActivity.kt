...
class AnnonceUserDetailActivity:AppCompatActivity() {
    ...
    private fun getIntentExtraData(){
        if (this.intent.hasExtra(AnnonceUserActivity.ANNONCE_MODEL_EXTRA)) {
            val annonceData = intent.getParcelableExtra<AnnonceModel>(AnnonceUserActivity.ANNONCE_MODEL_EXTRA)!!
